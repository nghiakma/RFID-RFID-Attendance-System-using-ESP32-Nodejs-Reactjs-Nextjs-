                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <input style={{flex: '1', borderRadius: '4px', padding: '2px 5px 2px 8px', color: '#6d41a1'}} type="email" className="form-input" placeholder="Nhập tài khoản"/>
                        </div>
                        <div style={{
                            display: 'flex', alignItems: 'center'
                        }}>
                            <label style={{width: '90px'}}>Password: </label>
                            <input style={{flex: '1', borderRadius: '4px', padding: '2px 5px 2px 8px', color: '#6d41a1' }} type="password" className="form-input" placeholder="Nhập mật khẩu"/>
                        </div>
